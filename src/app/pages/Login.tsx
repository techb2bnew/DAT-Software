...
export const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://exam.b2bcampus.com/api/auth/login", {
        method: "POST",
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] p-4 md:p-6 font-sans">
      <div className="w-full max-w-[440px]">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-gray-900 tracking-tight mb-2">Dat Software</h1>
          <p className="text-gray-500 font-medium">Please sign in to your Dat account.</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8 md:p-10">
          <form className="space-y-6" onSubmit={handleLogin}>
            {error && (
              <div className="flex items-center gap-3 bg-red-50 border border-red-100 p-4 rounded-2xl animate-pulse">
